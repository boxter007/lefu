...
**Q：乐府支持哪些音乐软件？**
已支持 **汽水音乐**、**Apple Music**（macOS 自带「音乐」）、**网易云音乐** 与 **酷我音乐**（本地与在线歌曲均可；Apple Music 广播直播暂未适配）。采用可扩展的音源架构，后续按需逐个接入 QQ 音乐等。接入新音源的方式见 [docs/ADDING-A-SOURCE.md](docs/ADDING-A-SOURCE.md)。
