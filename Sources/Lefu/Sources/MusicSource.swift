...
final class SourceRegistry {
    static let shared = SourceRegistry(sources: [SodaSource.self, AppleMusicSource.self, NetEaseSource.self, KuwoSource.self, KuGouSource.self, XimalayaSource.self])
